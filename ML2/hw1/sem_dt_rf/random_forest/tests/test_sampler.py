...
from sem_dt_rf.random_forest.sampler import BaseSampler, FeatureSampler, ObjectSampler
...
class ObjectsSamplerTests(TestCase):
    @mock.patch('sem_dt_rf.random_forest.sampler.BaseSampler.sample_indices',
    ...
    def test_base_scenario(self, indices):
        ...
        indices = np.array(indices.return_value)  # Добавлено
