...
from .sampler import FeatureSampler, ObjectSampler, BaseSampler
...
class RandomForest:
    ...
    def predict_proba(self, x):
        ...
        probas это трехмерный массив, а mean делает из него двумерный. 
        в каждой строке вероятности пренадлежности классам для i-го обьекта 
        """
        ...
        for i in range(self.n_estimators):
            ...
            propa = self.estimators[i].predict_proba(x_cur) 
            probas.append(propa)
